...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> ID = createField(DSL.name("id"), SQLDataType.VARCHAR(19).nullable(false), this, "");

    /**
     * The column <code>public.users.scope_id</code>.
     */
    public final TableField<UsersRecord, String> SCOPE_ID = createField(DSL.name("scope_id"), SQLDataType.CHAR(7).nullable(false), this, "");

    /**
     * The column <code>public.users.company_id</code>.
     */
    public final TableField<UsersRecord, String> COMPANY_ID = createField(DSL.name("company_id"), SQLDataType.VARCHAR(19).nullable(false), this, "");

    /**
     * The column <code>public.users.username</code>.
     */
    public final TableField<UsersRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(80).nullable(false), this, "");
